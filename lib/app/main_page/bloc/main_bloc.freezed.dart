...
/// @nodoc
abstract class _$$SelectImplCopyWith<$Res> implements $MainEventCopyWith<$Res> {
...
class __$$SelectImplCopyWithImpl<$Res>
    extends _$MainEventCopyWithImpl<$Res, _$SelectImpl>
...
class _$SelectImpl implements _Select {
  ...
  @override
  String toString() {
    return 'MainEvent.select(index: $index)';
  }
...
abstract class _Select implements MainEvent {
  const factory _Select(final int index) = _$SelectImpl;
