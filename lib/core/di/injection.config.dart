...
as _i1001;
import 'package:budget_fusion_app/shared/application/use_cases/watch_bookings_use_case.dart' as _i856;
import 'package:budget_fusion_app/shared/application/use_cases/watch_profile_setting_use_case.dart' as _i151;
import 'package:budget_fusion_app/shared/application/use_cases/watch_profile_use_case.dart' as _i712;
import 'package:budget_fusion_app/shared/domain/aggregator/profile_setting_aggregator.dart' as _i1029;
import 'package:budget_fusion_app/shared/shared.dart' as _i332;
import 'package:budget_fusion_app/utils/service/connectivity_service.dart' as _i702;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i174.GetIt> init({
    ...
    gh.lazySingleton<_i371.RealtimeNotifierService>(() => _i371.RealtimeNotifierService());
    gh.lazySingleton<_i870.CategoryRemoteDataSource>(() => _i870.CategoryRemoteDataSource());
    gh.lazySingleton<_i478.UserRemoteSource>(() => _i478.UserRemoteSource());
    gh.lazySingleton<_i121.BookingRemoteDataSource>(() => _i121.BookingRemoteDataSource());
    gh.lazySingleton<_i146.ProfileSettingRemoteDataSource>(() => _i146.ProfileSettingRemoteDataSource());
    gh.lazySingleton<_i594.ProfileRemoteDataSource>(() => _i594.ProfileRemoteDataSource());
    gh.lazySingleton<_i990.AccountRemoteDataSource>(() => _i990.AccountRemoteDataSource());
    gh.lazySingleton<_i971.FilterBookingsUseCase>(() => _i971.FilterBookingsUseCase());
    gh.lazySingleton<_i811.SummaryDataGenerator>(() => _i811.SummaryDataGenerator());
    gh.lazySingleton<_i25.DatetimeService>(() => _i25.DatetimeService());
    gh.lazySingleton<_i871.UserRepo>(() => _i871.UserRepo(gh<_i478.UserRemoteSource>()));
    gh.lazySingleton<_i702.ConnectivityService>(() => _i702.ConnectivityService(gh<_i895.Connectivity>()));
    gh.factory<_i991.LoginCubit>(() => _i991.LoginCubit(
          gh<_i871.UserRepo>(),
          gh<_i428.ConnectivityService>(),
        ));
    gh.lazySingleton<_i76.QueueLocalDataSource>(() => _i76.QueueLocalDataSource(gh<_i779.Database>()));
    gh.lazySingleton<_i342.CategoryLocalDataSource>(() => _i342.CategoryLocalDataSource(gh<_i779.Database>()));
    gh.lazySingleton<_i423.BookingLocalDataSource>(() => _i423.BookingLocalDataSource(gh<_i779.Database>()));
    gh.lazySingleton<_i652.ProfileSettingLocalDataSource>(() => _i652.ProfileSettingLocalDataSource(gh<_i779.Database>()));
    gh.lazySingleton<_i261.ProfileLocalDataSource>(() => _i261.ProfileLocalDataSource(gh<_i779.Database>()));
    gh.lazySingleton<_i431.AccountLocalDataSource>(() => _i431.AccountLocalDataSource(gh<_i779.Database>()));
    gh.lazySingleton<_i327.QueueManager>(() => _i327.QueueManager(gh<_i76.QueueLocalDataSource>()));
    ...
    gh.lazySingleton<_i714.ProfileSettingRepo>(() => _i52.ProfileSettingRepoImpl(
          gh<_i714.DataManagerFactory>(),
          gh<_i652.ProfileSettingLocalDataSource>(),
          gh<_i146.ProfileSettingRemoteDataSource>(),
        ));
    gh.lazySingleton<_i885.GenerateBudgetSummaryUseCase>(() => _i885.GenerateBudgetSummaryUseCase(
          gh<_i714.ProfileSettingRepo>(),
          gh<_i811.SummaryDataGenerator>(),
        ));
    gh.lazySingleton<_i311.LoadAccountsUseCase>(() => _i311.LoadAccountsUseCase(gh<_i714.AccountRepo>()));
    gh.lazySingleton<_i1001.WatchAccountsUseCase>(() => _i1001.WatchAccountsUseCase(gh<_i714.AccountRepo>()));
    ...
    gh.lazySingleton<_i324.LoadProfileUseCase>(() => _i324.LoadProfileUseCase(gh<_i714.ProfileRepo>()));
    gh.lazySingleton<_i712.WatchProfileUseCase>(() => _i712.WatchProfileUseCase(gh<_i714.ProfileRepo>()));
    ...
    gh.lazySingleton<_i1029.ProfileSettingAggregator>(() => _i1029.ProfileSettingAggregator(gh<_i714.ProfileSettingRepo>()));
    gh.lazySingleton<_i757.LoadProfileSettingUseCase>(() => _i757.LoadProfileSettingUseCase(gh<_i714.ProfileSettingRepo>()));
    gh.factory<_i151.WatchProfileSettingUseCase>(() => _i151.WatchProfileSettingUseCase(gh<_i714.ProfileSettingRepo>()));
    gh.lazySingleton<_i47.WatchCategoriesUseCase>(() => _i47.WatchCategoriesUseCase(gh<_i714.CategoryRepo>()));
    gh.lazySingleton<_i87.LoadCategoriesUseCase>(() => _i87.LoadCategoriesUseCase(gh<_i714.CategoryRepo>()));
    gh.lazySingleton<_i7.WatchCategoriesUseCase>(() => _i7.WatchCategoriesUseCase(gh<_i714.CategoryRepo>()));
    gh.lazySingleton<_i601.ResetBudgetBookUseCase>(() => _i601.ResetBudgetBookUseCase(
    ...
    gh.lazySingleton<_i624.LoadBookingsUseCase>(() => _i624.LoadBookingsUseCase(gh<_i714.BookingRepo>()));
    ...
    gh.lazySingleton<_i198.BudgetPageDataService>(() => _i198.BudgetPageDataService(
          gh<_i714.CategoryRepo>(),
          gh<_i428.DatetimeService>(),
        ));
    gh.factory<_i856.WatchBookingsUseCase>(() => _i856.WatchBookingsUseCase(gh<_i714.BookingRepo>()));
    gh.factory<_i190.BookingCubit>(() => _i190.BookingCubit(
          gh<_i332.WatchBookingsUseCase>(),
          gh<_i624.LoadBookingsUseCase>(),
        ));
    gh.lazySingleton<_i548.FilterAndGroupBookingsUseCase>(() => _i548.FilterAndGroupBookingsUseCase(gh<_i198.BudgetPageDataService>()));
