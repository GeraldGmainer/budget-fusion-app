...
abstract class OfflineFirstSingleRepo<T, U extends OfflineFirstDto> {
  ...
  OfflineFirstSingleRepo(EntityType entityType, DataManagerFactory dataManagerFactory, this.localDataSource, this.remoteDataSource)
    : manager = dataManagerFactory.createManager<U>(entityType: entityType, localDataSource: localDataSource, remoteDataSource: remoteDataSource);
