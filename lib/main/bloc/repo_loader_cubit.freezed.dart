...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RepoLoaderState);
}
...
/// @nodoc
class $RepoLoaderStateCopyWith<$Res>  {
$RepoLoaderStateCopyWith(RepoLoaderState _, $Res Function(RepoLoaderState) __);
}


/// Adds pattern-matching-related methods to [RepoLoaderState].
extension RepoLoaderStatePatterns on RepoLoaderState {
...
class _Initial implements RepoLoaderState {
  const _Initial();
...
class _Loading implements RepoLoaderState {
  const _Loading();
...
class _Success implements RepoLoaderState {
  const _Success();
...
class _Error implements RepoLoaderState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $RepoLoaderStateCopyWith<$Res> {
