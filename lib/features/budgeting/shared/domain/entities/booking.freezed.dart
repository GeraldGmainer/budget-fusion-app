...
class _$BookingImpl extends _Booking {
  ...
  @override
  String toString() {
    return 'Booking(id: $id, bookingDate: $bookingDate, description: $description, amount: $amount, category: $category, account: $account, isDeleted: $isDeleted)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, bookingDate, description,
      amount, category, account, isDeleted);
...
abstract class _Booking extends Booking {
  const factory _Booking(
      ...
      required final bool isDeleted}) = _$BookingImpl;
