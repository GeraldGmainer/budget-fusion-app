...
abstract class _$$LoginSuccessStateImplCopyWith<$Res> {
  factory _$$LoginSuccessStateImplCopyWith(
    _$LoginSuccessStateImpl value,
...
class __$$LoginSuccessStateImplCopyWithImpl<$Res>
  ...
  __$$LoginSuccessStateImplCopyWithImpl(
    _$LoginSuccessStateImpl _value,
...
abstract class LoginSuccessState implements LoginState {
  const factory LoginSuccessState(final User user) = _$LoginSuccessStateImpl;
...
class _$LoginErrorStateImpl implements LoginErrorState {
  const _$LoginErrorStateImpl(this.error);
...
abstract class LoginErrorState implements LoginState {
  const factory LoginErrorState(final AppError error) = _$LoginErrorStateImpl;
