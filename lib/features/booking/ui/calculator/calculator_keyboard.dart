  ...
  Widget build(BuildContext context) {
    return GridView.count(
      ...
      children: [
        ...
        CalculatorButton(calculatorKey: CalculatorKey.clear, onPressed: onPressed, backgroundColor: const Color(0xFFB36565)),
        ...
        CalculatorButton(calculatorKey: CalculatorKey.dot, onPressed: onPressed, icon: const Icon(CommunityMaterialIcons.circle_small, size: 30)),
        CalculatorButton(calculatorKey: CalculatorKey.back, onPressed: onPressed, icon: const Icon(CommunityMaterialIcons.backspace_outline, size: 22)),
        CalculatorButton(
