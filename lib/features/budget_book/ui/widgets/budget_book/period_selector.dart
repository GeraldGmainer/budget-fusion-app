...
class PeriodSelector extends StatelessWidget {
  ...
  void _onPrevious(BuildContext context) {
    ...
    if (pageController.hasClients) {
      ...
      // TODO send to sentry without ${paginatedController.drawer!.round()} / ${viewItems.length}
      BudgetLogger.instance.w("cannot navigate to next drawer: ${pageController.page!.round()} / ${viewItems.length}");
    }
  }
