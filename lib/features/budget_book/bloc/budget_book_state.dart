...
class BudgetBookState with _$BudgetBookState {
  ...
  const factory BudgetBookState.loading({required List<BudgetViewData> items, required BudgetBookFilter filter, required BudgetViewMode viewMode, required PeriodMode period}) =
      _Loading;
